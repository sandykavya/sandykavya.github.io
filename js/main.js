...
(function ($) {
    ...
    $(document).on("ready", function () {    
        ...
        $("#bearr-countdown-item").countdown( "2023/07/26 22:50:10" , function (event) {
      ...
      /*  $(document).ready(function() {
          ...
          var targetDateTime = "2023/07/26 22:15:10";
        
         
          $("#bearr-countdown-item").countdown(targetDateTime, function(event) {
            
        
            if (event.elapsed) {
              
              var element = document.getElementById("bearr-countdown-item");
              element.style.visibility = "hidden";
              document.getElementById("bearr-countdown-item").innerHTML="HI Hello good morning";
